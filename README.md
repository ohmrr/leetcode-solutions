...
| 867 | [Transpose Matrix](https://leetcode.com/problems/transpose-matrix/description/) | [Python](./array/0867_transpose_matrix.py) | Easy | $O(m \times n)$ | $O(m \times n)$ | Array, Matrix, Simulation | Create new matrix and switch the row and col for each element |
...
| 2114 | [Maximum Number of Words Found in Sentences](https://leetcode.com/problems/maximum-number-of-words-found-in-sentences/description/) | [Python](./array/2114_maximum_number_of_words_found_in_sentences.py) | Easy | $O(n \times m)$ | $O(1)$ | Array, String | For optimal space, count spaces in each sentence instead of splitting |
| 2185 | [Counting Words With a Given Prefix](https://leetcode.com/problems/counting-words-with-a-given-prefix/description/) | [Python](./array/2185_counting_words_with_a_given_prefix.py) | Easy | $O(n)$ | $O(1)$ | Array, String, String Matching | Check the first n characters of each word, where n is the length of the prefix |
